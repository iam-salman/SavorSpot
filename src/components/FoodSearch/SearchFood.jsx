...
const SearchFood = () => {
    ...
    const preSearchApi = PRE_SEARCH_API + `lat%3D${lat}%26lng%3D${lng}`;
    const searchApi = `${SEARCH_API}lat%3D${lat}%26lng%3D${lng}%26str%3D${query}%26trackingId%3Dnull`;
