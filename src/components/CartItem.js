      ...
      <div className="">
        ...
        <h5 className="font-medium mt-4 mb-3 ml-2">
          ...
          <span className="ml-56 font-medium border border-gray-300 px-2 py-1 text-green-500 shadow-md">
            <button className="hover:text-green-700"><i className="ri-subtract-fill font-extrabold pr-2"></i></button> 2
            <button className="hover:text-green-700"><i className="ri-add-fill font-extrabold pl-2"></i></button>
          </span>
        </h5>
      </div>
    </div>
